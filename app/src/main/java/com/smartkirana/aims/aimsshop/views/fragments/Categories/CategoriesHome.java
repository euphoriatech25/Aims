...
public class CategoriesHome extends Fragment implements ICategories.View, CategoriesAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_categories_home, parent, false);
